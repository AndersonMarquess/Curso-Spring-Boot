...
public class SwaggerConfig {
	//Representa os erros de forma personalizada
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.andersonmarques.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo(
				...
				"https://www.udemy.com/terms", Collections.emptyList() // Vendor
		);
	}
